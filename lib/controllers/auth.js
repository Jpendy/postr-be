...
function redirectUriFn() {
    switch (process.env.ENVIRONMENT) {
        case 'production': return 'https://postr/netlify.app';
        case 'dev': return 'https://dazzling-aryabhata-afd67f.netlify.app';
        case 'local': return 'http://localhost:7891';
        default: return 'http://localhost:7891';
    }
}